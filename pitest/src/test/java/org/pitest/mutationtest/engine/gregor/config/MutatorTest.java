...
public class MutatorTest {
  ...
  @Test
  public void testedKeysMatchPresentKeys() {
    assertThat(expectedMutators().keySet()).containsExactlyInAnyOrderElementsOf(Mutator.allKeys());
  }

  @Test
  public void allMutatorRegistrationsShouldBeAsExpected() {
    Map<String, List<String>> expectedMutators = expectedMutators();

    for (String key : Mutator.allKeys()) {
      assertThat(Mutator.fromStrings(key))
              .extracting(MethodMutatorFactory::getGloballyUniqueId)
              .describedAs("mutators for key: " + key)
              .containsExactlyElementsOf(expectedMutators.get(key));
    }
  }

  private Map<String, List<String>> expectedMutators() {
    HashMap<String, List<String>> expected = new HashMap<>();

    expected.put(
            "INVERT_NEGS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.InvertNegsMutator"));
    expected.put(
            "RETURN_VALS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.ReturnValsMutator"));
    expected.put(
            "INLINE_CONSTS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.InlineConstsMutator"));
    expected.put(
            "MATH",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.MathMutator"));
    expected.put(
            "VOID_METHOD_CALLS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.VoidMethodCallsMutator"));
    expected.put(
            "NEGATE_CONDITIONALS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.NegateConditionalsMutator"));
    expected.put(
            "CONDITIONALS_BOUNDARY",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.ConditionalsBoundaryMutator"));
    expected.put(
            "INCREMENTS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.IncrementsMutator"));
    expected.put(
            "REMOVE_INCREMENTS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.experimental.RemoveIncrementsMutator"));
    expected.put(
            "NON_VOID_METHOD_CALLS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.NonVoidMethodCallsMutator"));
    expected.put(
            "CONSTRUCTOR_CALLS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.ConstructorCallsMutator"));
    expected.put(
            "REMOVE_CONDITIONALS_EQ_IF",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.RemoveConditionalsMutator_EQUAL_IF"));
    expected.put(
            "REMOVE_CONDITIONALS_EQ_ELSE",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.RemoveConditionalsMutator_EQUAL_ELSE"));
    expected.put(
            "REMOVE_CONDITIONALS_ORD_IF",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.RemoveConditionalsMutator_ORDER_IF"));
    expected.put(
            "REMOVE_CONDITIONALS_ORD_ELSE",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.RemoveConditionalsMutator_ORDER_ELSE"));
    expected.put(
            "REMOVE_CONDITIONALS",
            asList(
    ...
    expected.put(
            "TRUE_RETURNS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.TrueReturnsMutator"));
    expected.put(
            "FALSE_RETURNS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.FalseReturnsMutator"));
    expected.put(
            "PRIMITIVE_RETURNS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.PrimitiveReturnsMutator"));
    expected.put(
            "EMPTY_RETURNS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.EmptyReturnsMutator"));
    expected.put(
            "NULL_RETURNS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.NullReturnsMutator"));
    expected.put(
            "RETURNS",
            asList(
    ...
    expected.put(
            ...
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.experimental.MemberVariableMutator"));
    expected.put(
            "EXPERIMENTAL_SWITCH",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.experimental.SwitchMutator"));
    expected.put(
            "EXPERIMENTAL_ARGUMENT_PROPAGATION",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.ArgumentPropagationMutator"));
    expected.put(
            "EXPERIMENTAL_NAKED_RECEIVER",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.experimental.NakedReceiverMutator"));
    expected.put(
            "EXPERIMENTAL_BIG_INTEGER",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.experimental.BigIntegerMutator"));
    expected.put(
            "AOR_1",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.AOR1Mutator"));
    expected.put(
            "AOR_2",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.AOR2Mutator"));
    expected.put(
            "AOR_3",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.AOR3Mutator"));
    expected.put(
            "AOR_4",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.AOR4Mutator"));
    expected.put(
            "ABS",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.ABSMutator"));
    expected.put(
            "AOD1",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.AOD1Mutator"));
    expected.put(
            "AOD2",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.AOD2Mutator"));
    expected.put(
            "CRCR1",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.CRCR1Mutator"));
    expected.put(
            "CRCR2",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.CRCR2Mutator"));
    expected.put(
            "CRCR3",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.CRCR3Mutator"));
    expected.put(
            "CRCR4",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.CRCR4Mutator"));
    expected.put(
            "CRCR5",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.CRCR5Mutator"));
    expected.put(
            "CRCR6",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.CRCR6Mutator"));
    expected.put(
            "OBBN1",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.OBBN1Mutator"));
    expected.put(
            "OBBN2",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.OBBN2Mutator"));
    expected.put(
            "OBBN3",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.OBBN3Mutator"));
    expected.put(
            "ROR1",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.ROR1Mutator"));
    expected.put(
            "ROR2",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.ROR2Mutator"));
    expected.put(
            "ROR3",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.ROR3Mutator"));
    expected.put(
            "ROR4",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.ROR4Mutator"));
    expected.put(
            "ROR5",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.ROR5Mutator"));
    expected.put(
            "UOI1",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.UOI1Mutator"));
    expected.put(
            "UOI2",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.UOI2Mutator"));
    expected.put(
            "UOI3",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.UOI3Mutator"));
    expected.put(
            "UOI4",
            singletonList("org.pitest.mutationtest.engine.gregor.mutators.rv.UOI4Mutator"));
    expected.put(
            "REMOVE_SWITCH",
            asList(
